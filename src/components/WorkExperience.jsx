...
const WorkExperience = () => {
    return (
        <>
            ...
            summary={"I work primarily in Java to help manage payment services. I gained experience in Spring Boot and SQL, and worked in a cooperative team environment."}
