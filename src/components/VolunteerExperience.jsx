    ...
    return (
        <>
            ...
            <VolunteerBlock name={"NYU Rapid Assembly and Design"} title={"Head of Programming"} dates={"September 2021 - January 2022"} location={"New York, NY"}
                summary={`Worked in a team of four to create a "smart" helmet for NYU's RAD competition. The smart helmet was a 3-D printed smart helmet 
                to address urban cycling dangers by detecting location and direction of obstacles in
                blind spots as well as bike speed. All information relayed to the biker through audio and tactile cues. As the head of programming, 
                I took care of all of the Arduino code and worked with developing and testing the software and wiring to ensure that the helmet works properly.`}
