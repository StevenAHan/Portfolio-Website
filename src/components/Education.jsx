...
const Education = ({toggleNYU, toggleEBHS}) => {
    return (
        <>
            ...
            summary={`Took 11 AP courses including computer science, math, physics, chemistry, language, history 
            | SAT: 1550 (770 English, 780 Math); SAT II: 800 (Math II), 790 (Physics), 780 (Biology Ecological)`}
