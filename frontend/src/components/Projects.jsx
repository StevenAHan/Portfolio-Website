    ...
    return (
        <> 
            ...
            <ProjectBlock title={"Love Letter Game Simulator"} dates={"May 2022 - Present"} 
                summary={"I created a card game simulator using C++, designed to be played by 2-4 players. The website is built with a ReactJS frontend using a custom Bootstrap theme and a Express with Socket.io backend, enabling multiplayer support. MongoDB is used to store game and user data."}
            ...
            <ProjectBlock title={"Steven's Minigames"} dates={"November 2022 - May 2023"} 
                summary={"I cretaed a website that hosted solvers I created using Python Flask. The solvers were created with C++ to be more efficient. Frontend created with HTML/CSS/JS and Bootstrap. Currently, I have created solvers for the popular 24 Game, Sudoku, and the Discord Activity Spellcast"}
